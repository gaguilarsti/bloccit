...
RSpec.describe PostsController, type: :controller do
  #added when we decided to associate users with posts and comments.
  ...
  #tests for when a user is not signed in.  # added a context for a guest (un-signed in) user.  Contexts organize tests based on the state of an object.
  context "guest user" do
    # tests for showing posts and topics so guests can see stuff when not logged in.
    ...
    # tests for other CRUD actions which all result in the unsigned user trying to do something and is redirected to sign in.  They can't do anything but view unless they are signed in.
    describe "GET new" do
